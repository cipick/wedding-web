  ...
  return (
      <>
        ...
        <header className="index-header">
          <div className="index-bg-left">
            <div
                className="index-bl-green-outline"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
            ...
            <div
                className="index-bl-yellow-flower"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "scale(1)"
            ...
            <div
                className="index-bl-moss-outline"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "scaleY(1)"
          ...
          <div className="index-bg-right">
            <div
                className="index-br-pink"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "rotate(0deg)"
            ...
            <div
                className="index-br-green-outline"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "rotate(0deg)"
            ...
            <div
                className="index-br-red-outline"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "rotate(0deg)"
            ...
            <div
                className="index-br-dark-outline"
                style={{
                  willChange: "transform, opacity",
                  opacity: 1,
                  transform: "scaleY(1)"
          ...
          <div className="index-header__subtitle">
            <h5 style={{ opacity: 1 }}>14 Iunie 2025</h5>
          </div>
          <div className="index-header__title">
            <h1 style={{ opacity: 1 }}>
              <div className="index-header__title-text">
                <span className="index-header__title-text-1">Cristina</span>
              </div>
              <div className="index-header__title-text">
                <span className="index-header__title-text-2">Ciprian</span>
              </div>
            </h1>
            <div className="index-header__cross">
              <div className="index-header__cross-1" />
              <div className="index-header__cross-2" />
            </div>
          </div>
        </header>
        <main className="main js-body-content">
          <section id="story" className="index-section index-story">
            <div className="container">
              <div className="row justify-content-md-center">
                <div className="col col-md-10">
                  <h5 className="text-center">Povestea noastra</h5>
                  <h2 className="text-center">Dance, Dance, Dance</h2>
                  <p className="large">
                    As a pair of determined designers, Daniela and Moe first got to
                    know each other working late nights in design studio during grad
                    school— brewing that third pot of coffee, sharing tasty treats,
                    and exchanging upbeat bops. Yet it wasn’t until a group outing
                    where they were left alone on the dance floor, grooving to funky
                    soul beats, when they knew they were meant to be together.
                  </p>
                </div>
              </div>
            </div>
        ...
        <footer className="site-footer" style={{}}>
          <div className="index-rsvp__right">
            ...
            >
              <g fillRule="nonzero" fill="none">
                <path
                    d="M66.6 841.3c-2.4-5.8-1.5-12.6.9-18.4 2.5-5.8 6.4-10.9 10.3-15.8 3.6-4.6 7.3-9.3 10.9-13.9 1.7-2.2 3.5-4.4 6.1-5.5 2.1-.9 4.5-.8 6.8-.6 21 1.2 42.5 4.6 63.6 3.1-32.5-32.6-90.2-30-119.6-65.4-22-26.5-19.7-67.6-1.1-96.7 5-7.9 11.5-15.4 20.4-18.4 17.6-6 35.2 8.1 48.6 21 13.1 12.7 26.5 25.8 33.3 42.7 2.9 7.2 4.5 14.9 6.5 22.4 3.9 15.1 8.
1 12.4 4.2 25.6-.4 37.3-2.5 6.5-3.5 11.9-8.1 17-11.9 13-28.2 21.9-45.5 24.8-3 30.4-5.7 60.9-4.5 91.4 2.7.9 5.4 1.9 8.3 1.8 2.9-.1 5.8-1.6 6.8-4.3-3.1-8.9 3.9-20.9 9.1-28.8 1.5-2.3 3-4.6 5.2-6.3 2-1.6 4.4-2.5 6.8-3.3 11.8-3.9 24.3-5.2 36.6-3.9-7.9 107.4 11.3 216.1 6 323.6-64.3 4.2-128.5 8.5-192.8 12.7-15.4 1-31.6 1.9-45.7-4.4-24.6-6.6-30.7-28.5-31-29.3z"
                    fill="#193C35"
                />
                <path
                    d="M78.2 502.8c.2 5.1.8 10.6 4.5 14.1 2.9 2.8 7.3 3.6 11.3 3.1 4-.5 7.7-2.2 11.4-3.8 1.2-.6 2.5-1.2 3.2-2.4.5-.9.5-2 .4-3-1-10-9.9-18.7-8.7-28.7 1.4-.6 2.7-1.2 4.1-1.8 2.4 1.9 4.8 3.7 7.1 5.6 4.8 3.7 9.8 7.6 15.8 8.3 6 .7 13-3.3 13.1-9.3.2-6.1-6.1-10.2-11.5-13.1l-12.6-6.6c3.2-3.6 8-5.5 12.3-7.7 4.3-2.2 8.6-5.6 9.6-10.4 1.1-5.6-2.8-10.9-6.4-15.3-3.1-3.7-6.3-7.6-10.7-9.4-4.4-1.9-10.4-1-12.8 3.2-1.1 1.8-1.9 4.6-4.1 4.4-.8-.1-1.6-.6-2.1-1.2-2.9-3.2-3.2-7.9-4.6-11.9-1.9-5.3-6-9.7-11.2-12-4.7-2-10.7-2-14.7 1.3-3.3 2.8-4.6 7.3-4.5 11.5.1 4.3 1.5 8.4 2.9 12.4-1.1.9-2.9.5-4.1-.4-1.1-.9-1.9-2.3-2.8-3.4-2.8-3.8-7.3-6-11.6-8-1.1-.5-2.3-1.1-3.6-1.1-2.2-.1-4.1 1.4-5.6 3-4.2 4.5-6.6 10.6-6.7 16.8 0 1.3.1 2.6.6 3.8.6 1.3 1.7 2.3 2.8 3.2 6.9 5.6 16.2 8.2 25 7.1.3 1.6.6 3.2.8 4.7-3.9 2.8-9.1 2.4-13.9 3-8.5 1.2-17.3 7.5-17.3 16.1-.1 10 10.8 16.7 13.3 26.4 4.1 2.2 9.7 1.3 12.9-2.1 1.9-2.1 2.9-4.9 4.1-7.5 1.2-2.7 10-18 13.6-15.6 2.8 1.6.6 23.1.7 26.7z"
                    fill="#EB4F22"
                />
              </g>
            </svg>
          ...
          <div className="" style={{ textAlign: "center" }}>
            <img src="/images/mark-dc6f1365.png" className="footer-mark" alt="Mark" />
            <div className="footer-attr">
              <div className="footer-attr__item">
          <span>
            <svg
                className="icon-illo"
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <defs>
                <clipPath id="a">
                  <path d="M0 15h20V0H0v15z" />
                </clipPath>
              </defs>
              <g clipPath="url(#a)" transform="matrix(1.25 0 0 -1.25 0 18.75)">
                <path d="M15.523 2.276c.33 0 .615.11.858.33.243.22.364.484.364.79 0 .123-.028.267-.084.432-.056.164-.15.377-.28.638l-1.165 2.35c-.087-1-.368-1.874-.843-2.62-.476-.746-1.16-1.385-2.055-1.92h3.206zm-.727 5.257L6.76 12.39l.262-1.772 7.56-4.586c.06.224.11.458.144.704.034.246.057.512.07.797m-.345-1.995L6.8 10.17 5.615 8.204l7.67-4.613c.268.274.498.572.69.896.193.322.35.674.476 1.052m-8.928 5.398c0-.386-.162-.8-.485-1.24-.323-.442-.622-.662-.895-.662-.155 0-.277.046-.364.14-.087.093-.13.223-.13.39 0 .387.16.808.485 1.264.322.457.618.685.885.685.15 0 .27-.052.364-.158.093-.106.14-.246.14-.42m7.382-7.708L5.29 7.804l-1.68-.606 8.017-4.792c.242.106.47.227.68.365.21.137.41.29.597.457m-6.376 7.448l-.307 2.04-2.078-.596-1.39-2.33.402-2.247 1.91.66 1.464 2.472zM17.49 3.357c.1-.186.17-.353.214-.498.043-.147.065-.28.065-.398 0-.21-.105-.372-.313-.484-.208-.112-.51-.168-.91-.168h-4.175c-.255 0-.472.024-.652.075-.18.05-.358.127-.53.232l-8.493 5.1L2.23 9.89l1.567 2.59 2.49.708 8.565-5.172c.155-.093.297-.218.424-.373s.247-.348.36-.578l1.854-3.71z" />
              </g>
            </svg>
          </span>
                Illustrations by the{" "}
                <a href="https://howmanyplants.com/">plant loving</a> bride
              </div>
              <div>
          <span>
            <svg
            ...
            >
              ...
              <g clipPath="url(#a)" transform="matrix(1.25 0 0 -1.25 0 18.75)">
                <path d="M12.792 8.777c.46 1.25.818 2.283 1.076 3.097.257.813.386 1.312.386 1.498 0 .2-.042.353-.13.463-.084.11-.203.165-.354.165-.192 0-.388-.16-.587-.48-.2-.317-.42-.83-.66-1.538l-1.03-2.977 1.3-.228zm-1.37-2.77c-.296.012-.576.043-.84.09-.264.05-.518.118-.757.207.11-.22.207-.44.293-.66.086-.218.156-.434.21-.646.166.206.34.392.52.56.184.17.374.318.573.448m-1.163 3.122l-1.113 3.215c-.288.817-.51 1.35-.67 1.602-.157.25-.33.376-.514.376-.144 0-.26-.054-.35-.164-.09-.11-.134-.257-.134-.444 0-.316.12-.865.36-1.648.24-.783.6-1.81 1.082-3.08.042.076.1.13.175.16.076.03.18.046.31.046.04 0 .123-.004.246-.01.123-.008.325-.024.607-.052m-1.01-4.976c.117 0 .224.054.32.16.096.107.144.222.144.345 0 .13-.093.435-.282.912-.19.476-.424.944-.706 1.406-.206.342-.41.602-.608.777-.2.175-.388.263-.566.263-.145 0-.304-.092-.48-.273-.175-.183-.262-.352-.262-.51 0-.165.085-.412.258-.742.17-.33.4-.68.69-1.05.302-.405.587-.72.854-.948.27-.226.48-.34.64-.34m-3.09.247c.095-.118.23-.29.4-.515.454-.626.873-.938 1.258-.938.13 0 .247.04.35.124.103.083.154.168.154.258 0 .104-.07.274-.206.516-.138.24-.326.51-.566.813-.275.35-.504.606-.685.767-.183.162-.33.243-.44.243-.24 0-.46-.13-.663-.387-.202-.257-.303-.56-.303-.91 0-.283.07-.597.21-.944.14-.347.345-.695.614-1.046.405-.543.91-.96 1.51-1.25.6-.294 1.265-.44 1.994-.44 1.338 0 2.46.5 3.363 1.5S14.5 4.44 14.5 5.944c0 .46-.033.826-.1 1.097-.07.27-.183.47-.34.593-.283.232-.83.442-1.645.628-.813.185-1.664.28-2.55.28-.246 0-.422-.043-.525-.125-.103-.082-.155-.224-.155-.423 0-.467.26-.806.783-1.014.522-.21 1.367-.314 2.536-.314h.42c.098 0 .175-.036.233-.108.06-.072.098-.18.12-.324-.118-.11-.358-.236-.722-.377-.364-.14-.643-.28-.834-.417-.412-.302-.743-.66-.994-1.076-.25-.416-.376-.81-.376-1.18 0-.227.053-.5.16-.82.106-.32.16-.516.16-.59V1.7l-.02-.092c-.304.02-.542.197-.717.53-.176.333-.263.778-.263 1.335v.092c-.055-.048-.108-.082-.16-.103-.05-.02-.108-.03-.17-.03-.062 0-.12.005-.174.014-.056.01-.118.027-.187.046.02-.075.036-.15.046-.22.01-.073.016-.13.016-.17 0-.255-.1-.473-.3-.654-.198-.183-.436-.274-.71-.274-.432 0-.873.212-1.32.634-.446.423-.668.836-.668 1.242 0 .074.008.142.025.2.017.06.046.108.087.15M13.534 8.6c.618-.116 1.054-.377 1.308-.783s.38-1.045.38-1.916c0-1.73-.52-3.147-1.56-4.25C12.622.552 11.292 0 9.67 0c-.64 0-1.26.115-1.86.346-.6.23-1.117.55-1.55.962-.495.454-.866.934-1.113 1.438-.247.505-.37 1.02-.37 1.55 0 .59.126 1.048.38 1.37.255.324.656.543 1.206.66-.104.24-.18.444-.227.608-.048.165-.072.292-.072.38 0 .31.163.626.49.95.326.322.634.484.922.484.124 0 .253-.023.39-.068.138-.044.296-.12.475-.22-.528 1.494-.913 2.65-1.152 3.466-.242.813-.36 1.374-.36 1.684 0 .425.108.764.328 1.015.22.25.518.376.897.376.645 0 1.462-1.442 2.45-4.326.173-.495.303-.877.393-1.143l.32.907c.988 2.856 1.84 4.286 2.554 4.286.35 0 .63-.12.84-.357.21-.237.314-.555.314-.953 0-.302-.115-.856-.345-1.658-.23-.805-.58-1.855-1.046-3.154" />
              </g>
            </svg>
          </span>
                Website by the goofy <a href="https://moeamaya.com/">groom</a>
              </div>
            </div>
          </div>
        </footer>
